...
class MusicMenu extends MusicBeatState
{
    ...
    var tapeRaze:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Cassette Rozebud'));
    var tapeJads:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Cassette Jads'));
    var tapeYing:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Cassette YingYang'));
    ...
    override function create()
    {
        ...
        var bg:FlxSprite = new FlxSprite(-10,-10).loadGraphic(Paths.image('RedBG'));
		add(bg);
		var hedge:FlxSprite = new FlxSprite(-810,-335).loadGraphic(Paths.image('hedge'));
		hedge.setGraphicSize(Std.int(hedge.width * 0.65));
		add(hedge);
        
        var repeatLine:FlxBackdrop = new FlxBackdrop(Paths.image('MusicRepeatLines'),1,1,false,true);
        repeatLine.velocity.set(0,14);
        repeatLine.screenCenter();
        repeatLine.x += 440;
        add(repeatLine);

        var menu:FlxSprite = new FlxSprite().loadGraphic(Paths.image('Red Box Music Menu'));
        menu.screenCenter();
        ...
        circleOne = new FlxSprite().loadGraphic(Paths.image("Circle1"));
        circleTwo = new FlxSprite().loadGraphic(Paths.image("Circle2"));
        ...
        if (FlxG.save.data.beatenHard || debug)
            indicator =  new FlxSprite().loadGraphic(Paths.image("MusicIndicationLines"));
        else 
            indicator =  new FlxSprite().loadGraphic(Paths.image("noJadsLine"));
		...
		var menuShade:FlxSprite = new FlxSprite(-1350,-1190).loadGraphic(Paths.image("Menu Shade"));
